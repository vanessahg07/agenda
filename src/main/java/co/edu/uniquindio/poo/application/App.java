...
public class App {
    public static void main(String[] args) {
        ...
        Categoria opcionSelexionada = Categoria.OFICINA;
                    ...
                    for (; repetirMenu3;) {
                        ...
                        switch (accionElegida) {
                            ...
                            case "1":
                                ...
                                switch (accionElegida) {
                                    case "1":
                                        opcionSelexionada = Categoria.OFICINA;
                                        ...
                                        opcionSelexionada.equals(Categoria.OFICINA);
                                        break;
                                    case "2":
                                        opcionSelexionada = Categoria.FIESTA;
                                    ...
                                    case "3":
                                        opcionSelexionada = Categoria.AMIGOS;
                                        ...
                                        break;
                                    case "4":
                                        opcionSelexionada = Categoria.FAMILIA;
